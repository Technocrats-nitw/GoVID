...
from voctor.data.dataset import create_dataset_for_ffn
from voctor.models import chatModel
from voctor.utils import qa_pair_loss, qa_pair_cross_entropy_loss,qa_pair_batch_accuracy
...
def multi_gpu_train(batch_size, num_gpu, data_path, num_epochs, model_path, loss=qa_pair_loss):
    ...
    with mirrored_strategy.scope():
        ...
        medical_qa_model.add(chatModel())
