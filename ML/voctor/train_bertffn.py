...
from voctor.dataset import create_dataset_for_bert
from voctor.models import chatModelwithBert
from voctor.loss import qa_pair_loss, qa_pair_cross_entropy_loss
...
def train_bertffn(model_path='models/bertffn_crossentropy/bertffn',
    ...
    https://github.com/Santosh-Gupta/voctor/blob/master/README.md
    ...
    medical_qa_model = chatModelwithBert(
