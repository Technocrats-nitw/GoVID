...
from voctor.data.dataset import create_dataset_for_bert
from voctor.models import chatModelwithBert
from voctor.utils import qa_pair_batch_accuracy,qa_pair_loss, qa_pair_cross_entropy_loss
from voctor.tokenization import FullTokenizer


DEVICE = "/gpu:0"

def train_bertffn_estimator(model_path='models/bertffn_crossentropy/bertffn',
    ...
    base_model = chatModelwithBert(config_file=os.path.join(
